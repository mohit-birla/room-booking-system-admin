...
const generateRoomsScreen = (meetingRooms) => {
  ...
  let meetingRoomHtml = `<div class="w-75 m-3 p-3">
                ...
                <tbody>
                    ${meetingRooms?.map((item) => {
                      ...
                      return `<tr>
                                        ...
                                        <td>${item.capacity}</td>
                                        <!-- <td><button type="button" class="btn btn-info" id="roomStatus" onclick="changeStatus()">${
                                          item.roomStatus
                                        }</button></td>-->
                                        ...
                                        <td><button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addRoomModel" onclick="getDataToUpdateRoom(${
                                          item.room_id
                                        })">Edit</button></td>
                                        <td><button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteRoomModal" onclick="deleteRoomIdSaver(${
                                          item.room_id
                                        })">Delete</button></td>
                                              ...
                                              item.roomId
                                                ...
                                                <div>
                                                    <div class="container d-flex justify-content-between mt-2">
                                                        ...
                                                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addSlotModel" onclick="addSlotFunction(${
                                                          item.roomId
                                                        })">Add Slots</button>
                                                    ...
                                                    ${
                                                      item.roomSlots
                                                        ...
                                                        : `<div style="text-align: center;"><h5>No Unavailabe Slots</h5></div>`
                                                    }
                                                </div>
                                            </div>
                                        </td>
...
let submitRoom = () => {
  ...
  if (!room_code || !room_name || !capacity) {
